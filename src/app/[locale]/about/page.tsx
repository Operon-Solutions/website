  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pb-24">
        <div className="max-w-[720px] mx-auto px-6 space-y-16">
          {d.sections.map((section: { heading: string; body: string }) => (
            <div key={section.heading}>
              <h2 className="font-serif text-[clamp(1.3rem,2.5vw,1.8rem)] tracking-tight mb-4">{section.heading}</h2>
              <p className="text-[15px] text-fg/35 leading-[1.8]">{section.body}</p>
            </div>
          ))}
        </div>
      </section>
