...
const ICONS: Record<string, string> = {
  monitor: "M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5",
...
export default function PlatformGrid() {
  ...
  const industryData = dict.platform.industries;
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="reveal mb-14">
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <span className="text-[13px] text-fg/40 font-medium">{dict.platform.popularServices}</span>
          </div>
          <h2 className="font-serif text-[clamp(1.7rem,4vw,2.8rem)] leading-[1.15] max-w-2xl tracking-tight">
            {dict.platform.heading}
            <br />
            <span
